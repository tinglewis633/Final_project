...
export default function EditProfileForm(props) {
  ...
  return (
   <form method="POST" action={`/api/editprofile/${id}`}> 
      ...
      <p>date of birth</p>
      <input name="dob" required placeholder="Enter date of birth" onChange={onChangeDateOfBirth} value={newUserDateOfBirth}></input>

      <button type="submit">    Save profile changes
      </button>
      </form>
